...
#include <memory>
#include "../../C++/qjackctl/qjackctlPatchbayRack.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qjackctlPatchbayRack_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qjackctlPatchbayRack_t qt_meta_stringdata_qjackctlPatchbayRack = {
    {
QT_MOC_LITERAL(0, 0, 20), // "qjackctlPatchbayRack"
QT_MOC_LITERAL(1, 21, 14), // "cableConnected"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 11), // "sOutputPort"
QT_MOC_LITERAL(4, 49, 10), // "sInputPort"
QT_MOC_LITERAL(5, 60, 12) // "uiCableFlags"

    },
    "qjackctlPatchbayRack\0cableConnected\0"
    "\0sOutputPort\0sInputPort\0uiCableFlags"
};
...
void qjackctlPatchbayRack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cableConnected((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&qjackctlPatchbayRack::cableConnected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject qjackctlPatchbayRack::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_qjackctlPatchbayRack.data,
